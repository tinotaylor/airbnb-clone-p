  ...
  return (
    <div className="my-2 ">
      <div
        ...
        className="flex flex-col md:flex-row  p-3 cursor-pointer bg-white hover:shadow-lg pr-3transition transform duration-300 ease-out md:hover:ml-5 lg:hover:ml-8 hover:scale-[1.02] group rounded-2xl"
      >
        ...
        <div
          ...
          className="relative min-h-[20rem] rounded-2xl  md:h-60 md:w-80 lg:w-80 xl:w-80 hover:opacity-95 flex-shrink-0 overflow-hidden "
        >
          <Image
            src={img}
            layout="fill"
